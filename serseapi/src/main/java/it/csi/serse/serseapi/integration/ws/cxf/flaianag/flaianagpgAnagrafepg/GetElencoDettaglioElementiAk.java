 ...
 *         &lt;element name="in3" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getElencoDettaglioElementiAk")
public class GetElencoDettaglioElementiAk {

    protected Integer in0;
    protected String in1;
    protected Integer in2;
    protected List<String> in3;
     ...
     * This is why there is not a <CODE>set</CODE> method for the in3 property.
     * 
     * <p>
     ...
     * 
     */
    public List<String> getIn3() {
        if (in3 == null) {
            in3 = new ArrayList<String>();
        }
        return this.in3;
    }
