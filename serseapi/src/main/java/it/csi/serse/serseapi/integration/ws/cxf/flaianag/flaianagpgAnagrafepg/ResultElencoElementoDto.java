...
/**
 * <p>Classe Java per ResultElencoElementoDto complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="ResultElencoElementoDto"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="elencoElementi" type="{http://anagrafepg.interfacecsi.flaianagpg.flaianag.csi.it/}ArrayOfElementoDto"/&gt;
...
@XmlType(name = "ResultElencoElementoDto", propOrder = {
    "elencoElementi",
    "resultMessage"
})
public class ResultElencoElementoDto {

    @XmlElement(required = true, nillable = true)
    protected ArrayOfElementoDto elencoElementi;
    @XmlElement(required = true, nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfElementoDto }
     *     
     */
    public ArrayOfElementoDto getElencoElementi() {
     ...
     *     
     */
    public void setElencoElementi(ArrayOfElementoDto value) {
