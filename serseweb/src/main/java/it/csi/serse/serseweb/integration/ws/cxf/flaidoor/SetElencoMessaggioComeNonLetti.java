 ...
 *       &lt;sequence&gt;
 *         &lt;element name="in0" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "setElencoMessaggioComeNonLetti")
public class SetElencoMessaggioComeNonLetti {

    protected List<String> in0;
     ...
     * 
     */
    public List<String> getIn0() {
        if (in0 == null) {
            in0 = new ArrayList<String>();
        }
        return this.in0;
    }
