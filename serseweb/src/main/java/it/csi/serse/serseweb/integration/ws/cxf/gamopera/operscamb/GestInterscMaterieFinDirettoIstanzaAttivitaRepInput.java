...
/**
 * <p>Classe Java per gestInterscMaterieFinDirettoIstanzaAttivitaRepInput complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="gestInterscMaterieFinDirettoIstanzaAttivitaRepInput"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="elencoSoggetti" type="{http://operscambserv.interfacews.operserv.gamopera.csi.it/}soggettoFinDirettoIstanzaAttivitaRep" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="elencoEdizioni" type="{http://operscambserv.interfacews.operserv.gamopera.csi.it/}edizioneFinDirettoIstanzaAttivitaRep" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "gestInterscMaterieFinDirettoIstanzaAttivitaRepInput", propOrder = {
    "codiceTipoMateria",
    "codiceTipoRichiesta",
    "idPso",
    "idSportello",
...
public class GestInterscMaterieFinDirettoIstanzaAttivitaRepInput {
    ...
    protected List<SoggettoFinDirettoIstanzaAttivitaRep> elencoSoggetti;
    @XmlElement(nillable = true)
    protected List<EdizioneFinDirettoIstanzaAttivitaRep> elencoEdizioni;
     ...
     * {@link SoggettoFinDirettoIstanzaAttivitaRep }
     * 
     * 
     */
    public List<SoggettoFinDirettoIstanzaAttivitaRep> getElencoSoggetti() {
        if (elencoSoggetti == null) {
            elencoSoggetti = new ArrayList<SoggettoFinDirettoIstanzaAttivitaRep>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EdizioneFinDirettoIstanzaAttivitaRep }
     * 
     * 
     */
    public List<EdizioneFinDirettoIstanzaAttivitaRep> getElencoEdizioni() {
        if (elencoEdizioni == null) {
            elencoEdizioni = new ArrayList<EdizioneFinDirettoIstanzaAttivitaRep>();
        }
