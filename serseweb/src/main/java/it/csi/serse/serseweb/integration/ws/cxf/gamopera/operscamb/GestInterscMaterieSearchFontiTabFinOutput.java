...
/**
 * <p>Classe Java per gestInterscMaterieSearchFontiTabFinOutput complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="gestInterscMaterieSearchFontiTabFinOutput"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="elencoFonti" type="{http://operscambserv.interfacews.operserv.gamopera.csi.it/}materieSearchFontiTabFinDto" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "gestInterscMaterieSearchFontiTabFinOutput", propOrder = {
    "codEsito",
    "descEsito",
    "elencoFonti"
})
public class GestInterscMaterieSearchFontiTabFinOutput {

    protected String codEsito;
    protected String descEsito;
    @XmlElement(nillable = true)
    protected List<MaterieSearchFontiTabFinDto> elencoFonti;
     ...
     * {@link MaterieSearchFontiTabFinDto }
     * 
     * 
     */
    public List<MaterieSearchFontiTabFinDto> getElencoFonti() {
        if (elencoFonti == null) {
            elencoFonti = new ArrayList<MaterieSearchFontiTabFinDto>();
        }
