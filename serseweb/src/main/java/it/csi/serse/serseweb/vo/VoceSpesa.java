...
public class VoceSpesa   {
  ...
  public boolean equals(Object o) {
    ...
    VoceSpesa voceSpesa = (VoceSpesa) o;
    return Objects.equals(codVoceSpesa, voceSpesa.codVoceSpesa) &&
        Objects.equals(descrVoceSpesa, voceSpesa.descrVoceSpesa) &&
        Objects.equals(codNaturaSpesa, voceSpesa.codNaturaSpesa);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codVoceSpesa, descrVoceSpesa, codNaturaSpesa);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VoceSpesa {\n");
    
    sb.append("    codVoceSpesa: ").append(toIndentedString(codVoceSpesa)).append("\n");
    sb.append("    descrVoceSpesa: ").append(toIndentedString(descrVoceSpesa)).append("\n");
    sb.append("    codNaturaSpesa: ").append(toIndentedString(codNaturaSpesa)).append("\n");
    sb.append("}");
    return sb.toString();
  }
