...
import it.csi.serse.serseweb.api.RuoliApi;
...
@Component
public class RuoliApiImpl extends ParentOverWebApi  implements RuoliApi {
	...
	public Response getRuoli(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders,
		...
		return Response.ok().entity(securityHelper.findRuoliForPersonaInApplication(httpRequest)).build();
	}
