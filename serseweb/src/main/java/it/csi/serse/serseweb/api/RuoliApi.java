...
import it.csi.serse.serseweb.vo.Ruolo;
...
public interface RuoliApi  {
    ...
    /**
     * summary = ruoli dell'utente autenticato
     * description = restituisce i ruoli dell'utente autenticato
     * @return Response
     * responses: 
       <ul>
         <li>    
           <p>responseCode = 200, description = successo<br>
           schema implementation = { @see Ruolo }</p>
         </li>
         <li>    
    ...
    */
    ...
    Response getRuoli(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
