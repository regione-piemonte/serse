...
import it.csi.serse.serseweb.utils.DumpUtils;
...
public class LoggingAspectConfig {
	...
	protected static Logger BUSINESS_LOGGER = LogManager.getLogger(Constants.COD_COMPONENTE + ".business");
	protected static Logger INTEGRATION_LOGGER = LogManager.getLogger(Constants.COD_COMPONENTE + ".integration");
	...
	@Around("execution(* it.csi.serse.serseweb.api.manager..*.*(..))")
	...
	@Around("execution(* it.csi.serse.serseweb.integration..*.*(..))")
	...
	@AfterThrowing(pointcut = "execution(* it.csi.serse.serseweb.integration..*.*(..))", throwing = "exception")
	...
	@AfterThrowing(pointcut = "execution(* it.csi.serse.serseweb.api.manager..*.*(..))", throwing = "exception")
