package it.csi.serse.serseweb.integration.mybatis.generator;
...
public class MybatisGenerator {
	...
	static final String PROJECT_NAME="serseweb";
	
	private static Logger LOG = LogManager.getLogger(Constants.COD_COMPONENTE + ".tracer");
