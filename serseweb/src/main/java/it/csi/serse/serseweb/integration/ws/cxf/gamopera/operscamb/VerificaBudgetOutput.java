...
/**
 * <p>Classe Java per verificaBudgetOutput complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="verificaBudgetOutput"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="datiServizio" type="{http://operscambserv.interfacews.operserv.gamopera.csi.it/}datiServizioOutput" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "verificaBudgetOutput", propOrder = {
...
public class VerificaBudgetOutput {
    ...
    protected List<DatiServizioOutput> datiServizio;
     ...
     * {@link DatiServizioOutput }
     * 
     * 
     */
    public List<DatiServizioOutput> getDatiServizio() {
        if (datiServizio == null) {
            datiServizio = new ArrayList<DatiServizioOutput>();
        }
