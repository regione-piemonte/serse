 ...
 *       &lt;sequence&gt;
 *         &lt;element name="in0" type="{http://flaidoorsrv.interfacecsi.orchflai.flaidoor.csi.it/}Identita" minOccurs="0"/&gt;
 *         &lt;element name="in1" type="{http://flaidoorsrv.interfacecsi.orchflai.flaidoor.csi.it/}Application" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "findActorsForPersonaInApplicationConcurrent")
public class FindActorsForPersonaInApplicationConcurrent {
