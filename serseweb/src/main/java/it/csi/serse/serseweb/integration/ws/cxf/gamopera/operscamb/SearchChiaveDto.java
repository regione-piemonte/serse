...
/**
 * <p>Classe Java per searchChiaveDto complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="searchChiaveDto"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="elencoAreeTerritoriali" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "searchChiaveDto", propOrder = {
    "idSportello",
    "gruppoOperatore",
    "codOperatore",
    "nrDomanda",
    ...
    "idAutorizzazione",
    "elencoAreeTerritoriali"
})
public class SearchChiaveDto {
    ...
    protected List<String> elencoAreeTerritoriali;
    ...
    /**
     * Gets the value of the elencoAreeTerritoriali property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the elencoAreeTerritoriali property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getElencoAreeTerritoriali().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getElencoAreeTerritoriali() {
        if (elencoAreeTerritoriali == null) {
            elencoAreeTerritoriali = new ArrayList<String>();
        }
        return this.elencoAreeTerritoriali;
    }
