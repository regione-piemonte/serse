...
export interface ExportExcelIntervento{
  tipolPso:string,
  sportello:string,
  ...
  finalitaIntervento:string|null,
  idModello:number|null,
  referente:string|undefined,
  statoIntervento:string,
  cognNomeDesctinatario:string,
  cFDestinatario:string,
  tipologieServizi:string|undefined,
  totserviziAssociati:number|undefined,
  totserviziAssociatiChiusi:number|undefined,
